...
func (r ExpiryReason) MarshalDynamoDBAttributeValue() (types.AttributeValue, error) {
	return &types.AttributeValueMemberS{Value: r.String()}, nil
}

func (r *ExpiryReason) UnmarshalDynamoDBAttributeValue(av types.AttributeValue) error {
	var s string
